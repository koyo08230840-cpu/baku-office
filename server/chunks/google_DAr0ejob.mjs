...
import { disconnectGoogle, googleStatus, setGoogleGroups, grantedScopeString } from "./google_cIMnQJbU.mjs";
import { getServiceAccountInfo, saveServiceAccount, saveWifConfig, testServiceAccount } from "./google-sa_BQsetpcp.mjs";
...
const POST = async ({ request, locals }) => {
  ...
  if (b._action === "probe") {
    ...
    const { probeGoogleApis } = await import("./google-probe_DerdrVfA.mjs");
