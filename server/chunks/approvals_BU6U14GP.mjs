...
import { $ as $$ApprovalTabs } from "./ApprovalTabs_BwkLW8mT.mjs";
...
const $$Approvals = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { getSession, canAccess } = await import("./auth_qjtEFOY-.mjs");
  ...
  const { listApprovals, getApprovalMode } = await import("./approvals_DakhuEZU.mjs");
