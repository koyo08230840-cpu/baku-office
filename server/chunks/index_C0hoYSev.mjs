...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (Astro2.locals.publicHost) {
    ...
    const { getPublicPage } = await import("./public-pages_C8bkA-DV.mjs");
  ...
  const { cachedEntitlement, hasApiKey } = await import("./client_Ceeu_qGY.mjs");
  ...
  const ttsCloudReady = await (await import("./capabilities_CcY7RZcf.mjs")).ttsConfigured(env).catch(() => false);
  ...
  const [{ getMemberModel }, { listSkills }, { listScheduledTasks }] = await Promise.all([
    ...
    import("./skills_B4vWtV1j.mjs"),
    import("./scheduled-tasks_D3SPs4rF.mjs")
  ]);
