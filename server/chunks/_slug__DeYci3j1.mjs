...
import { $ as $$SiteLockGate, a as $$PublicSite } from "./SiteLockGate_De6ExLh7.mjs";
const prerender = false;
const $$slug = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$props, $$slots);
  Astro2.self = $$slug;
  const { slug } = Astro2.params;
  const { getPublishedSite, getSite } = await import("./sites_D1KDcV1z.mjs");
  ...
  const { siteLocked } = await import("./sites_D1KDcV1z.mjs");
