...
const $$Update = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { pollHost, APP_VERSION } = await import("./client_Ceeu_qGY.mjs");
  const { hasDeployHook, cmpVersion, getAutoUpdate, getAutoUpdateStatus } = await import("./update_DN9VKrrA.mjs");
