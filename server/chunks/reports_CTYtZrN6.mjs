...
const $$Reports = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const { monthKpi } = await import("./kpi_Ctve0qAw.mjs");
  const { TASK_KIND_LABEL } = await import("./task-log_sFx7hDXA.mjs");
